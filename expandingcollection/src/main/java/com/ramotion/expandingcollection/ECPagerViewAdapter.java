...
public abstract class ECPagerViewAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        Bitmap bitmapRes = dataset.get(position).getHeadBackgroundResourceBitmap();
        if (bitmapRes != null) {
            headView.setHeadImageBitmap(bitmapRes);//BitmapFactory.decodeResource(pagerContainer.getResources(), drawableRes, new BitmapFactoryOptions()));
        }
