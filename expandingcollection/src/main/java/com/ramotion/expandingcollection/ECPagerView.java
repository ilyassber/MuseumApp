...
public class ECPagerView extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    public void onPageSelected(int position) {
        ...
        if (attachedImageSwitcher != null) {
            ...
            Integer mainBitmapKey = pager.getDataFromAdapterDataset(position).getMainBitmapKey(); //mainBgImageDrawableResource = pager.getDataFromAdapterDataset(position).getMainBackgroundResource();
            if (instance.getBitmapFromBgMemCache(mainBitmapKey) != null) {
